...
pkgdatadir = $(datadir)/apertium-rus-olr
pkgincludedir = $(includedir)/apertium-rus-olr
pkglibdir = $(libdir)/apertium-rus-olr
pkglibexecdir = $(libexecdir)/apertium-rus-olr
...
am__installdirs = "$(DESTDIR)$(apertium_rus_olrdir)"
DATA = $(apertium_rus_olr_DATA) $(noinst_DATA)
...
ACLOCAL = ${SHELL} '/home/eugenia/apertium-rus-olr/missing' aclocal-1.16
AMTAR = $${TAR-tar}
...
APERTIUM_RUS_CFLAGS = 
APERTIUM_RUS_LIBS = 
AP_LIB1 = ../apertium-rus
AP_LIB2 = ../apertium-olr
AP_SRC1 = ../apertium-rus
AP_SRC2 = ../apertium-olr
AP_SUBDIRS =  ../apertium-rus ../apertium-olr
AUTOCONF = ${SHELL} '/home/eugenia/apertium-rus-olr/missing' autoconf
AUTOHEADER = ${SHELL} '/home/eugenia/apertium-rus-olr/missing' autoheader
AUTOMAKE = ${SHELL} '/home/eugenia/apertium-rus-olr/missing' automake-1.16
AWK = gawk
...
CTAGS = ctags
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"Apertium\ Russian-Olrat\" -DPACKAGE_TARNAME=\"apertium-rus-olr\" -DPACKAGE_VERSION=\"0.1.0\" -DPACKAGE_STRING=\"Apertium\ Russian-Olrat\ 0.1.0\" -DPACKAGE_BUGREPORT=\"https://github.com/apertium/apertium-rus-olr/issues\" -DPACKAGE_URL=\"https://wiki.apertium.org/wiki/Apertium-rus-olr\" -DPACKAGE=\"apertium-rus-olr\" -DVERSION=\"0.1.0\"
ECHO_C = 
ECHO_N = -n
ECHO_T = 
ETAGS = etags
...
MAKEINFO = ${SHELL} '/home/eugenia/apertium-rus-olr/missing' makeinfo
MKDIR_P = /usr/bin/mkdir -p
PACKAGE = apertium-rus-olr
PACKAGE_BUGREPORT = https://github.com/apertium/apertium-rus-olr/issues
PACKAGE_NAME = Apertium Russian-Olrat
PACKAGE_STRING = Apertium Russian-Olrat 0.1.0
PACKAGE_TARNAME = apertium-rus-olr
PACKAGE_URL = https://wiki.apertium.org/wiki/Apertium-rus-olr
...
VERSION = 0.1.0
ZCAT = /usr/bin/zcat
abs_builddir = /home/eugenia/apertium-rus-olr
abs_srcdir = /home/eugenia/apertium-rus-olr
abs_top_builddir = /home/eugenia/apertium-rus-olr
abs_top_srcdir = /home/eugenia/apertium-rus-olr
am__leading_dot = .
...
install_sh = ${SHELL} /home/eugenia/apertium-rus-olr/install-sh
...
TARGETS_COMMON = $(TARGETS_DIR1) $(TRIMMED_TARGETS_DIR1) \
	$(TARGETS_DIR2) $(TRIMMED_TARGETS_DIR2) $(am__append_1)
SOURCES = \
...
###############################################################################
###############################################################################
apertium_rus_olrdir = $(prefix)/share/apertium/$(BASENAME)/

# Files which should be installed to $(prefix)/share/apertium/$(BASENAME)/:
apertium_rus_olr_DATA = $(TARGETS_COMMON) $(SOURCES)
...
$(am__aclocal_m4_deps):
install-apertium_rus_olrDATA: $(apertium_rus_olr_DATA)
	@$(NORMAL_INSTALL)
	@list='$(apertium_rus_olr_DATA)'; test -n "$(apertium_rus_olrdir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(apertium_rus_olrdir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(apertium_rus_olrdir)" || exit 1; \
	fi; \
	for p in $$list; do \
	...
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(apertium_rus_olrdir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(apertium_rus_olrdir)" || exit $$?; \
	done

uninstall-apertium_rus_olrDATA:
	@$(NORMAL_UNINSTALL)
	@list='$(apertium_rus_olr_DATA)'; test -n "$(apertium_rus_olrdir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(apertium_rus_olrdir)'; $(am__uninstall_files_from_dir)
...
installdirs:
	for dir in "$(DESTDIR)$(apertium_rus_olrdir)"; do \
...
install-data-am: install-apertium_rus_olrDATA install-data-local
...
uninstall-am: uninstall-apertium_rus_olrDATA uninstall-local
...
.PHONY: CTAGS GTAGS TAGS all all-am am--refresh check check-am clean \
	...
	info-am install install-am install-apertium_rus_olrDATA \
...
rus-olr: $(TARGETS_DIR1) $(TRIMMED_TARGETS_DIR1)
olr-rus: $(TARGETS_DIR2) $(TRIMMED_TARGETS_DIR2)
